const uberStudy = {
  ...
  research: {
    ...
    findings: {
      statistics: [
        "65% of drivers considered English to be their second language",
        "34% of those drivers felt that the inability to communicate caused problems during rides",
        "73% of riders considered English to be their second language",
        "21% of those riders felt like the riding experience was uncomfortable when there was a language barrier",
        "39% of drivers felt communicating with passengers was crucial for quality service.",
        "14% of riders indicated that they like to chat leisurely with their driver"
      ]
    },
    personas: [
      "Bryant",
